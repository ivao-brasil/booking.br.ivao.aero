...
const enTranslations: { translations: Translations, nativeName:string, englishName:string } = {
  englishName: 'English',
  nativeName: 'English',
  translations: {
    generics: {
    ...
    divisions:{
      ...
      VN: 'Vietnam',
      XA: 'North America Region',
      XB: 'BELUX Region',
      XC: 'Dutch Caribbean MCD',
      XE: 'East Asia Region',
      XG: 'GCC Region',
      XM: 'Middle East Region',
      XN: 'Nordic Region',
      XO: 'Oceanic Region',
      XR: 'Eastern Europe and Northern Asia',
      XS: 'Central America Region',
      XT: 'South Caucasus Region',
      XU: 'United Kingdom and Ireland MCD',
      XY: 'Malaysia and Singapore MCD',
      XZ: 'Southern Africa Region',
      ZA: 'South Africa',
      ZW: 'Zimbabwe'
    },
    divisionsFilter: {
      selectDivisions: 'Select Divisions',
      filterDivisions: 'Filter Divisions'
    },
    footer: {
