...
const esTranslations: { translations: Translations, englishName: string, nativeName: string } = {
  ...
  translations: {
    ...
    divisions: {
      ...
      VN: 'Vietnam',
      XA: 'Región de América del Norte',
      XB: 'Región BELUX',
      XC: 'Caribe Neerlandés MCD',
      XE: 'Región de Asia Oriental',
      XG: 'Región GCC',
      XM: 'Región de Oriente Medio',
      XN: 'Región Nórdica',
      XO: 'Región Oceánica',
      XR: 'Europa del Este y Asia del Norte',
      XS: 'Región de América Central',
      XT: 'Región del Cáucaso del Sur',
      XU: 'Reino Unido e Irlanda MCD',
      XY: 'Malasia y Singapur MCD',
      XZ: 'Región de África Austral',
      ZA: 'Sudáfrica',
      ZW: 'Zimbabue'
    },
    divisionsFilter: {
      selectDivisions: 'Seleccionar Divisiones',
      filterDivisions: 'Filtrar Divisiones'
    },
    footer: {
