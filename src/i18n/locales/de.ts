...
const deTranslations: { translations: Translations, englishName: string, nativeName: string } = {
  englishName: 'German',
  nativeName: 'Deutsch',
  translations: {
    generics: {
    ...
    divisions: {
      ...
      FI: 'Finnland',
      FR: 'Frankreich',
      GB: 'Vereinigtes Königreich und Irland',
      GE: 'Georgien',
      GR: 'Griechenland',
      GT: 'Guatemala',
      GU: 'Guam',
      ...
      VN: 'Vietnam',
      XA: 'Nordamerika-Region',
      XB: 'BELUX-Region',
      XC: 'Niederländische Karibik MCD',
      XE: 'Ostasien-Region',
      XG: 'GCC-Region',
      XM: 'Nahost-Region',
      XN: 'Nordische Region',
      XO: 'Ozeanische Region',
      XR: 'Osteuropa und Nordasien',
      XS: 'Zentralamerika-Region',
      XT: 'Südkaukasus-Region',
      XU: 'Vereinigtes Königreich und Irland MCD',
      XY: 'Malaysia und Singapur MCD',
      XZ: 'Südafrika-Region',
      ZA: 'Südafrika',
      ZW: 'Simbabwe'
    },
    divisionsFilter: {
      selectDivisions: 'Wähle eine Division',
      filterDivisions: 'Divisionen filtern'
    },
    footer: {
