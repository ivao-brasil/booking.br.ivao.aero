...
const frTranslations: { translations: Translations, englishName: string, nativeName: string } = {
  englishName: 'French',
  nativeName: 'Français',
  translations: {
    generics: {
    ...
    divisions: {
      ...
      VN: 'Vietnam',
      XA: 'Région Amérique du Nord',
      XB: 'Région BELUX',
      XC: 'Caraïbes Néerlandaises MCD',
      XE: 'Région Asie de l\'Est',
      XG: 'Région GCC',
      XM: 'Région Moyen-Orient',
      XN: 'Région Nordique',
      XO: 'Région Océanique',
      XR: 'Europe de l\'Est et Asie du Nord',
      XS: 'Région Amérique Centrale',
      XT: 'Région Caucase du Sud',
      XU: 'Royaume-Uni et Irlande MCD',
      XY: 'Malaisie et Singapour MCD',
      XZ: 'Région Afrique Australe',
      ZA: 'Afrique du Sud',
      ZW: 'Zimbabwe'
    },
    divisionsFilter: {
      selectDivisions: 'Sélectionner les divisions',
      filterDivisions: 'Filtrer les divisions'
    },
    footer: {
