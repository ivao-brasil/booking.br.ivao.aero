    ...
    return (
        <div className="mt-[4.3rem]">
            ...
            <div className="flex flex-wrap justify-between mt-7 space-y-4 lg:space-y-0">
                <p className="max-w-lg font-action text-justify max-h-80 overflow-y-auto pr-3 pb-1 lg:pb-0 scrollbar-thin scrollbar-thumb-light-gray-5 dark:scrollbar-thumb-dark-gray-5 scrollbar-thumb-rounded">
                    {event.description}
                </p>
