      ...
      <div className='flex flex-col md:flex-row space-y-4 md:space-y-0'>
        ...
        <div className='flex-1'>
          <ActionButton
            ...
            content={
              <span
                className={`block px-5 py-2.5 leading-[37px] text-center font-action font-semibold text-gray dark:text-white truncate w-full`}>
                <span>{t('cookies.continueWithout')} <img className='inline-block w-4' alt='crying face'
                                                          src={emoji}/></span>
              </span>
            }
